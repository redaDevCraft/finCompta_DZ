...
/**
 * Clients = Contact where type in (client, both).
...
class ClientController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        $clients = $query
            ...
            ->withSum(['invoices as invoices_total' => function ($q) {
        ...
        return Inertia::render('Clients/Index', [
            ...
            'kpis' => $this->partyKpis($companyId, '411'),
        ]);
    }
    ...
    public function show(Request $request, Contact $contact): Response
    {
        ...
        abort_unless(in_array($contact->type, ['client', 'both'], true), 404);
        ...
        $invoices = Invoice::query()
            ...
            ->get([
                ...
                'total_ttc', 'status', 'document_type',
            ]);

        $ledger = $this->partyLedger($contact, '411');
    ...
    protected function partyKpis(string $companyId, string $prefix): array
    {
        ...
        return [
            'open_receivable' => round((float) ($row->debit ?? 0) - (float) ($row->credit ?? 0), 2),
            'prefix' => $prefix,
        ];
    }
